            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            <div class="col-lg-14">
                                <button id="myBtn" class="btn btn-primary" type="button" style="position: absolute; right: 2%;"> Add Equipment</button>
                                <div id="myModal" class="modal">
                                    <!-- Modal content -->
                                    <form method="post" action="simplemodal.php" id="myform" enctype="multipart/form-data">
                                        <div class="row" style="justify-content: center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                                            <div class="col-xl-8">
                                            <!-- Account details card-->
                                                <div class="card mb-2" style="border-style: solid;border-width: 3px; border-color: #690001;">
                                                    <div class="card-body">
                                                        <div class="row gx-3 mb-3">
                                                            <div class="col-mb-3" style="text-align: center;">
                                                                <label class="small mb-1" for="inputFirstName"><h3>Incorrect Password</h3></label>
                                                            </div>
                                                            <div class="col-mb-3" style="text-align: center;">
                                                                <label class="small mb-1" for="inputFirstName">The Password you entered is Incorrect. Please try again.</label>
                                                            </div>
                                                        </div>
                                                        <!-- Save changes button-->
                                                        <button class="btn btn-primary btn-block" type="submit" style="width: 100%;"> O K </button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-14">
                                <button id="myBtn" class="btn btn-primary" type="button" style="position: absolute; right: 2%;"> Login Successfully</button>
                                <div id="myModal" class="modal">
                                    <!-- Modal content -->
                                    <form method="post" action="simplemodal.php" id="login" enctype="multipart/form-data">
                                        <div class="row" style="justify-content: center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                                            <div class="col-xl-8">
                                            <!-- Account details card-->
                                                <div class="card mb-2" style="border-style: solid;border-width: 3px; border-color: #690001;">
                                                    <div class="card-body">
                                                        <div class="row gx-3 mb-3">
                                                            <div class="col-mb-3" style="text-align: center;">
                                                                <label class="small mb-1" for="inputFirstName"><h3>Login Successfully</h3></label>
                                                            </div>
                                                            <div class="col-mb-3" style="text-align: center;">
                                                                <label class="small mb-1" for="inputFirstName">You are now login.</label>
                                                            </div>
                                                        </div>
                                                        <!-- Save changes button-->
                                                        <button class="btn btn-primary btn-block" type="submit" style="width: 100%;"> Continue </button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
