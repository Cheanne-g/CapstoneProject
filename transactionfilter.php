            ...
            <div id="layoutSidenav_content">
                 <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Transaction <button id="myBtn" class="btn btn-primary" type="button" style="position: absolute; right: 2%;"> Filter </button></h1>
                        <div id="myModal" class="modal">
                        <!-- Modal content -->
                            <form method="post" action="transactionfilter.php" id="myform" enctype="multipart/form-data">
                                <div class="row" style="justify-content: center; margin-top: 10%;">
                                    <div class="col-xl-5">
                                        ...
                                        <div class="card mb-4" style="border-style: solid;border-width: 3px; border-color: #690001;">
                                            <div class="card-header"><div class="close" style="float: right;">&times;</div><h3>Office</h3></div>
                                            <div class="card-body">
                                                <div class="row gx-3 mb-3">
                                                    <div class="col-mb-3">
                                                        <label class="small mb-1 " for="office">Office</label>
                                                            <select id="inputState" name= "office" class="form-control">
                                                                <option value=" "> </option>
                                                                <option value="MAC LAB">MAC LAB</option>
                                                                <option value="CISCO">CISCO</option>
                                                                <option value="HEB LAB">HEB LAB</option>
